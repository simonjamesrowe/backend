...
public final class TestUtils {
    ...
    // Mock GET endpoint with JSON response
    ...
    // Mock GET endpoint with image response
    ...
    // Generate random test object with custom field values
