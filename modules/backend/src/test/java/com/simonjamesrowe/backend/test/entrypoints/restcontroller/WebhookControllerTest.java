...
import com.simonjamesrowe.backend.dataproviders.elasticsearch.blog.BlogDocument;
import com.simonjamesrowe.backend.dataproviders.elasticsearch.blog.BlogDocumentRepository;
...
class WebhookControllerTest extends BaseIntegrationTest {
    ...
    void webhookHandlerShouldProduceMessageToKafkaTopic() throws Exception {
        ...
        await().atMost(Duration.ofSeconds(30))
            .untilAsserted(() -> assertThat(testStreamListener.events).isNotEmpty());
    ...
    @Test
    void kafkaEventConsumerShouldIndexPublishedBlogs() {
        ...
        await().atMost(Duration.ofSeconds(60))
            .untilAsserted(() -> assertThat(blogDocumentRepository.count()).isEqualTo(2L));

        BlogDocument doc2 = blogDocumentRepository.findById("2").orElseThrow();
        assertThat(doc2.getId()).isEqualTo("2");
        assertThat(doc2.getTitle()).isEqualTo("My second blog");
        assertThat(doc2.getContent()).isEqualTo("Some awesome content again");
        assertThat(doc2.getTags()).isEqualTo(List.of("Spring", "Kotlin"));
        assertThat(doc2.getSkills()).isEqualTo(List.of("TestContainers"));
        assertThat(doc2.getThumbnailImage()).isEqualTo("uploads/image2-thumb.jpg");
        assertThat(doc2.getSmallImage()).isEqualTo("uploads/image2-sml.jpg");
        assertThat(doc2.getMediumImage()).isEqualTo("uploads/image2-med.jpg");
        assertThat(doc2.getCreatedDate()).isEqualTo(LocalDate.now());
    }
}
...
class TestStreamListener {
    ...
    @KafkaListener(topics = "${namespace:LOCAL}_EVENTS", groupId = "webhook-controller-test")
